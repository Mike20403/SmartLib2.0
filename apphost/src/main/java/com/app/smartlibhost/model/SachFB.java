...
public class SachFB implements Serializable, Parcelable {
    ...
    public static final Creator<SachFB> CREATOR = new Creator<SachFB>() {
        @Override
        public SachFB createFromParcel(Parcel in) {
            return new SachFB(in);
        }

        @Override
        public SachFB[] newArray(int size) {
            return new SachFB[size];
        }
    };
    ...
    public SachFB(String id_sach, String barcode, String id_theloai, String id_ngonngu, String tensach, String tentacgia, String Mota, String NXB, String soluong, String img_sach, String conlai, String date_added) {
        this.id_sach = id_sach;
        this.barcode = barcode;
        this.id_theloai = id_theloai;
        this.id_ngonngu = id_ngonngu;
